try {
	if (args[0].tag != "OnUse" || args[0].macroPass != "postActiveEffects" || !args[0].isCritical || !["mwak", "rwak", "msak", "rsak"].includes(args[0].item.system.actionType) || !args[0].damageDetail.find(d => d.type == "bludgeoning")) return;
    const effectData = {
