...
effects.find(e=>e.name=="Frightened"&&MidiQOL.canSense(canvas.tokens.get(tokenId),canvas.tokens.placeables.find(t=>t.actor&&(t.actor.id==e.origin.match(/Actor\.(.*?)\./)[1]||t.actor.flags.dnd5e.originalActor==e.origin.match(/Actor\.(.*?)\./)[1]))))
