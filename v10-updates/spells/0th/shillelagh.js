try {
    ...
    if (args[0] === "on") {
        ...
        if (!weapon) weapon = game.actors.contents.find(a => a.items.find(i => i.flags["midi-qol"].shillelagh === lastArg.efData._id)).items.find(i => i.flags["midi-qol"].shillelagh === lastArg.efData._id);
