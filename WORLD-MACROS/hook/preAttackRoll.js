        ...
        for (let t = 0; t < targets.length; t++) {
            ...
            try {
                ...
                for (let w = 0; w < wordTokens.length; w++) {
                    ...
                    let useWord = false;
                    useWord = await USF.socket.executeAsUser("useDialog", player.id, { title: `Cutting Words`, content: `Use your reaction and a bardic inspiration die to reduce the attack roll against ${tactor.name}?` });
                    if (useWord) {
