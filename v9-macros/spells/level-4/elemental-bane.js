...
if (args[0].tag === "OnUse" && lastArg.failedSaveUuids.length !== 0) {
    ...
    const effectData = {
        ...
        changes: [
            { key: `data.traits.dr.value`, mode: CONST.ACTIVE_EFFECT_MODES.CUSTOM, value: `-${type}`, priority: 20 },
        ...
        flags: { "dae": { itemData: lastArg.item, token: tactorTarget.uuid, stackable: "noneName" } },
    }
